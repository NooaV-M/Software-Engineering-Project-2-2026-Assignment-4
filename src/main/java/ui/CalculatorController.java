...
public class CalculatorController {
    ...
    public void calculateTotal() {
        Double total = priceCalculator.getTotal(currentLocale.toString());
    ...
    public void addToTotal() {
        priceCalculator.getCurrentItemPrice(textFieldPrice.getText());
        priceCalculator.getCurrentItemQuantity(textFieldQuantity.getText());
